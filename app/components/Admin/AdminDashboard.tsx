...
export function AdminDashboard({
  ...
  const stats = {
    ...
    collectedFees: contractStats ? Number(contractStats[2]) / 1e18 : 0, // Convert from wei to ETH
    activeApprovers: 5, // TODO: Add function to get active approvers count
    contractBalance: contractStats ? Number(contractStats[5]) / 1e18 : 0,
    platformFee: contractStats ? Number(contractStats[1]) / 100 : 1 // Convert to percentage
  };
