...
export default function AIAssistant({ className = '', isOpen: externalIsOpen, onClose }: AIAssistantProps) {
  ...
  return (
    <>
      {/* Floating AI Assistant Button - only show if not externally controlled */}
