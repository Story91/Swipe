...
export default function PNLAddressPage() {
  ...
  const handleOpenApp = () => {
    router.push('/?dashboard=user&pnl=true');
  };
      ...
      <div className="w-full max-w-[424px] mx-auto px-4 py-6">
        ...
        {allUserPredictions.length > 0 ? (
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-8 text-center">
            <p className="text-gray-400 mb-4">No predictions found for this user.</p>
            <button
